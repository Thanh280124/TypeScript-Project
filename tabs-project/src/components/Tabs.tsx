        ...
        <div className="flex flex-wrap">
          {Array.from({ length: 6 }).map((_, index) => (
            <Card
              ...
              image="https://plus.unsplash.com/premium_photo-1742654495030-ba75d666e16b?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            />
          ))}
        </div>
      ),
